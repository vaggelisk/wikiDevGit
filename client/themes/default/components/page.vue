<template lang="pug">
  v-app(v-scroll='upBtnScroll', :dark='$vuetify.theme.dark', :class='$vuetify.rtl ? `is-rtl` : `is-ltr`')
    ...
    v-main(ref='content')
      ...
      v-divider
      v-container(v-if='path===`frombrochurewrongdesign`')
        v-row.browse-button-section
          v-btn.my-0.ml-3.mr-0.radius-7(primary, x-large, color='green', @click='pageEdit')
